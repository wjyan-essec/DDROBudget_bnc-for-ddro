...
rem Usage: test_n100_BB.bat [total time limit in seconds]
...
set "STEM=N100_rc_0.7_rGamma_1_dc_0.035_dGamma_0.0005_jeu_100_"
...
set "RUN_DIR=%ROOT%test_runs\N100_BB_%RANDOM%_%RANDOM%"
if exist "%RUN_DIR%" (
...
echo N100 density 50 and 75: 20 instances
echo Method: %METHOD%
...
echo All 20 N100 branchandbound runs completed.
exit /b 0
